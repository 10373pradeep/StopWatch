package com.pkscoding.stopwatch
...
import com.pkscoding.stopwatch.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startTimer() {
        ...
        binding.startStopButton.icon = getDrawable(R.drawable.baseline_replay_24)
        timerStarted = true
    ...
    private fun stopTimer() {
       ...
       stopService(serviceIntent)
        ...
        binding.startStopButton.icon = getDrawable(R.drawable.baseline_play_circle_outline_24)
        timerStarted = false
